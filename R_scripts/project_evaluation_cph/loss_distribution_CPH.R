...
ggsave(filename = "Loss_Distribution_dyke_CPH.eps",
       plot = f,
       device="eps",
       dpi = 600)
...
ggsave(filename = "Premium_Distribution_dyke_time_CPH.eps",
       plot = f,
       device="eps",
       width =7,
       height = 7,
...
ggsave(filename = "Premium_Distribution_Top_cover_dyke_time_CPH.eps",
       plot = f,
       device="eps",
       dpi = 600)
...
ggsave(filename = "Premium_Distribution_Dyke_CPH.eps",
       plot = f,
       device="eps",
       dpi = 600)
...
write.table(results, "Quantile_Dyke_CPH.csv", sep = "&")
