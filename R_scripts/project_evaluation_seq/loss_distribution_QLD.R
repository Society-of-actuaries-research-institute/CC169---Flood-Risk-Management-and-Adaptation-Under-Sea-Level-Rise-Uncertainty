...
ggsave(filename = "Loss_Distribution_elevation_QLD.eps",
       plot = f,
       device="eps",
       dpi = 600)
...
ggsave(filename = "Premium_Distribution_elevation_logscale_time_QLD.eps",
       plot = f,
       width = 7,
       height  = 7,
       device="eps",
...
ggsave(filename = "Premium_Distribution_elevation_time_QLD.eps",
       plot = f,
       width = 7,
       height = 7,
       device="eps",
...
ggsave(filename = "Premium_Distribution_Top_cover_elevation_time_QLD.eps",
       plot = f,
       width = 7,
       height = 7,
       device="eps",
...
f = f + xlab("Years") + ylab("Loss Disitrubtion ($Billion) on log-scale")
...
ggsave(filename = "Premium_Distribution_Top_cover_elevation_logscale_time_QLD.eps",
       plot = f,
       width = 7,
       height = 7,
       device="eps",
...
ggsave(filename = "Premium_Distribution_elevation_QLD.eps",
       plot = f,
       device="eps",
       dpi = 600)
...
ggsave(filename = "Stopping_time_elevation_qld.eps",
       plot = f,
       device="eps",
       dpi = 600)
...
results[1,] = as.numeric(quantile(no_policy[1165,]*1000))
results[2,] = as.numeric(quantile(elevation[1165,]*1000))

write.table(results, "Quantile_Elevation.csv", sep = "&")
